    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
            ...
            <head>
                ...
                <title>Create Product - ZShoe-Giày Cho Giới Trẻ</title>
                                            ...
                                            <form:form method="post" action="/admin/product/create" class="row"
                                                ...
                                                <div class="mb-3 col-12 col-md-6">
                                                    ...
                                                    <form:select class="form-select" path="category.name">
                                                        <form:option value="Shoe">Giày</form:option>
                                                        <form:option value="Socks">Tất</form:option>
                                                        <form:option value="Insole">$ế lót giày</form:option>
                                                        <form:option value="Shoe Cleaning">Dụng Cụ Vệ Sinh Giày
                                                        </form:option>
                                                    </form:select>
                                                </div>
                                                <div class="mb-3 col-12 col-md-6">
