...
import com.example.ShopShoe.Service.UploadService;
...
public class ProductController {
    ...
    public String handleCreateProduct(
        ...
        pr.setImage(image);
        pr.setBrand(this.productService.getBrandByName(pr.getBrand().getName()));
        pr.setCategory(this.productService.getCategoryByName(pr.getCategory().getName()));
